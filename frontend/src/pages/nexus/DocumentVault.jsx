    ...
    return (
        <div className="space-y-12 animate-fade-in-up pb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="bg-slate-50 p-10 rounded-[3rem] flex flex-col items-center justify-center space-y-4 group cursor-pointer hover:bg-blue-600 transition-colors">
                ...
                <div className="p-10 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                    {docs.map((doc) => (
                        <div key={doc.id} className="p-8 rounded-[2.5rem] bg-slate-50/50 border border-transparent hover:border-blue-200 hover:bg-white hover:shadow-xl transition-all group flex flex-col justify-between h-64">
                            ...
                            <button className="w-full py-4 bg-white border border-slate-200 rounded-2xl text-[9px] font-black uppercase tracking-widest text-slate-500 hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all">
