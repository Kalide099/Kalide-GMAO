                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-8 bg-slate-950/80 backdrop-blur-md animate-fade-in">
                    <div className="bg-white rounded-[4rem] w-full max-w-2xl shadow-2xl border border-white/20 overflow-hidden animate-scale-in">
                        <div className="p-12 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                            <div>
                                <h3 className="text-4xl font-black text-slate-900 tracking-tighter uppercase italic">{t('workOrders.add_title')}</h3>
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mt-2">{t('workOrders.initProtocol')}</p>
                            </div>
                        ...
                        <form onSubmit={handleCreateOrder} className="p-12 space-y-10 max-h-[70vh] overflow-y-auto custom-scrollbar">
                            ...
                            <div className="space-y-4">
                                ...
                                <select 
                                    ...
                                    className="w-full px-8 py-5 rounded-[1.5rem] bg-slate-50 border border-slate-100 focus:border-indigo-600 transition-all font-black text-slate-800 uppercase text-xs appearance-none cursor-pointer"
                                >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                <div className="space-y-4">
                                    ...
                                    <select 
                                        ...
                                        className="w-full px-8 py-5 rounded-[1.5rem] bg-slate-50 border border-slate-100 focus:border-indigo-600 transition-all font-black text-slate-800 uppercase text-xs cursor-pointer"
                                    >
                            ...
                            <div className="space-y-4">
                                ...
                                <input 
                                    ...
                                    className="w-full px-8 py-5 rounded-[1.5rem] bg-slate-50 border border-slate-100 focus:border-indigo-600 transition-all font-black text-slate-800 uppercase text-xs"
                                />
                            </div>
