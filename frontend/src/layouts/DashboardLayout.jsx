...
const DashboardLayout = () => {
  ...
  const menuItems = [
    ...
    { id: 'nexus_suite', items: [
      ...
      { icon: <Activity size={20} />, label: t('nav.offlineMode'), path: '/app/nexus/offline' },
    ]},
    { id: 'administration', role: ['admin', 'super_admin', 'system_admin'], items: [
      ...
      { icon: <ShieldCheck size={20} />, label: t('nav.mfaSecurity'), path: '/app/mfa-security' },
      { icon: <ShieldCheck size={20} />, label: t('nav.audit'), path: '/app/audit' },
    ]},
    { id: 'enterprise_autonomy', items: [
      { icon: <Bot size={20} />, label: t('nav.aiCopilot'), path: '/app/ai-copilot', module: 'copilot' },
      { icon: <Radio size={20} />, label: t('nav.droneFleet'), path: '/app/drone-fleet', module: 'drone' },
      { icon: <ShoppingCart size={20} />, label: t('nav.aiProcurement'), path: '/app/ai-procurement', module: 'procurement' },
      { icon: <Eye size={20} />, label: t('nav.visionDefect'), path: '/app/vision-defect', module: 'vision' },
      { icon: <Layers size={20} />, label: t('nav.workflowBuilder'), path: '/app/workflows', module: 'workflow' },
      { icon: <FileText size={20} />, label: t('nav.reportingStudio'), path: '/app/reports', module: 'reporting' },
      { icon: <Wrench size={20} />, label: t('nav.tenantSettings'), path: '/app/settings', module: 'tenant_settings' },
    ]},
    { id: 'emerging_markets_hub', items: [
      { icon: <BatteryCharging size={20} />, label: t('nav.microGrid'), path: '/app/micro-grid', module: 'micro_grid' },
      { icon: <PhoneCall size={20} />, label: t('nav.ussdOffline'), path: '/app/ussd-offline', module: 'ussd_offline' },
      { icon: <Droplet size={20} />, label: t('nav.theftLeak'), path: '/app/leak-detection', module: 'leak_detection' },
      { icon: <Wind size={20} />, label: t('nav.dustPredictive'), path: '/app/dust-predictive', module: 'dust_predictive' },
      { icon: <Map size={20} />, label: t('nav.routeRisk'), path: '/app/route-risk', module: 'route_risk' },
      { icon: <Snowflake size={20} />, label: t('nav.solarCold'), path: '/app/solar-cold', module: 'solar_cold' },
      { icon: <MessageSquare size={20} />, label: t('nav.communityFault'), path: '/app/community-fault', module: 'community_fault' },
      { icon: <Smartphone size={20} />, label: t('nav.mobileMoney'), path: '/app/mobile-money', module: 'mobile_money' },
      { icon: <Activity size={20} />, label: t('nav.pipelineIntegrity'), path: '/app/pipeline-integrity', module: 'pipeline_integrity' },
      { icon: <Sun size={20} />, label: t('nav.offGrid'), path: '/app/off-grid', module: 'off_grid' },
      { icon: <TrendingDown size={20} />, label: t('nav.inflationSync'), path: '/app/inflation-sync', module: 'inflation_sync' },
      { icon: <Crosshair size={20} />, label: t('nav.antiPoaching'), path: '/app/anti-poaching', module: 'anti_poaching' },
      { icon: <Layers size={20} />, label: t('nav.lowBandwidth'), path: '/app/low-bandwidth-twin', module: 'low_bandwidth_twin' }
    ]}
  ];
